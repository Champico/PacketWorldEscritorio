...
public class Colaborador {
    ...
    public Colaborador(int idColaborador, String noPersonal, String nombre, String apellidoPaterno, String apellidoMaterno, String correo, String password, String curp, int idSucursal, String nombreSucursal, int idRol, String rol, byte[] foto, String fotoBase64, String numLicencia, Integer idUnidad) {
